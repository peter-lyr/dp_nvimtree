...
require 'which-key'.register {
  ...
  ['<leader>dd'] = { name = 'nvimtree.sel_dir', },
  ['<leader>ddl'] = { function() M.last_dir() end, B.b(M, 'last_dir'), mode = { 'n', 'v', }, silent = true, },
  ['<leader>ddd'] = { function() M.sel_dirs() end, B.b(M, 'sel_dirs'), mode = { 'n', 'v', }, silent = true, },
  ['<leader>ddr'] = { function() M.sel_dirvers() end, B.b(M, 'sel_dirvers'), mode = { 'n', 'v', }, silent = true, },
  ['<leader>ddu'] = { function() M.sel_parent_dirs() end, B.b(M, 'sel_parent_dirs'), mode = { 'n', 'v', }, silent = true, },
  ['<leader>ddp'] = { function() M.sel_path_dirs() end, B.b(M, 'sel_path_dirs'), mode = { 'n', 'v', }, silent = true, },
  ['<leader>ddg'] = { function() M.sel_from_all_git_repos() end, B.b(M, 'sel_from_all_git_repos'), mode = { 'n', 'v', }, silent = true, },
  ['<leader>dd<c-g>'] = { function() M.scan_all_git_repos() end, B.b(M, 'scan_all_git_repos'), mode = { 'n', 'v', }, silent = true, },
  ['<leader>ddh'] = { function() M.sel_SHGetFolderPath() end, B.b(M, 'sel_SHGetFolderPath'), mode = { 'n', 'v', }, silent = true, },
