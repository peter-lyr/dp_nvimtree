...
require 'which-key'.register {
  ...
  ['<leader>d<c-p>'] = { function() M.sel_path_dirs() end, B.b(M, 'sel_path_dirs'), mode = { 'n', 'v', }, silent = true, },
  ...
  ['<leader>dd'] = { function() M.sel_dirvers() end, B.b(M, 'sel_dirvers'), mode = { 'n', 'v', }, silent = true, },
  ['<leader>de'] = { function() M.refresh_hl() end, B.b(M, 'refresh_hl'), mode = { 'n', 'v', }, silent = true, },
  ['<leader>dg<leader>'] = { function() M.sel_from_all_git_repos() end, B.b(M, 'sel_from_all_git_repos'), mode = { 'n', 'v', }, silent = true, },
  ['<leader>dgf'] = { function() M.scan_all_git_repos() end, B.b(M, 'scan_all_git_repos'), mode = { 'n', 'v', }, silent = true, },
  ['<leader>dh'] = { function() M.sel_SHGetFolderPath() end, B.b(M, 'sel_SHGetFolderPath'), mode = { 'n', 'v', }, silent = true, },
  ...
  ['<leader>dl'] = { function() M.last_dir() end, B.b(M, 'last_dir'), mode = { 'n', 'v', }, silent = true, },
  ['<leader>dm'] = { function() M.sel_my_dirs() end, B.b(M, 'sel_my_dirs'), mode = { 'n', 'v', }, silent = true, },
  ['<leader>do'] = { function() M.open_all() end, B.b(M, 'open_all'), mode = { 'n', 'v', }, silent = true, },
  ['<leader>dp'] = { function() M.sel_parent_dirs() end, B.b(M, 'sel_parent_dirs'), mode = { 'n', 'v', }, silent = true, },
